...
$("#quantity, #price, #discount, #dis_type").on("keydown keyup", function(){
  ...
  function sub_total(){
    ...
    alert(document.getElementById('sub_total').value);
...
function addmore()
    {
          ...
          '</td>'+
          '<td>'+
          '<input class="form-control" type="number" id="quantity'+i+'" name="quantity[]" required autocomplete="quantity">'+
          '</td>'+
          '<td>'+
          '<input class="form-control" type="number" id="price'+i+'" name="price[]" required autocomplete="price" readonly>'+
          '</td>'+
          '<td>'+
          ...
          '</td>'+
          '<td>'+
          '<input class="form-control" type="number" id="sub_total'+i+'" name="sub_total[]" required autocomplete="sub_total" disabled="true" readonly>'+
          '</td>'+
          '</tr>';
          $('.show').append(tr);
...
// });
  ...
  //ki bujhlen/first time asce na kano vi
  //uporer line er calcualtion kotahi korchei block e cholen

//total er value ki grand total e chaccen?/jiii via/amar aro add more a click dile same name a input field asa
//oegular sum hoye grand total a bosbe/via ami ki aktu apnake call korte pari.daran age dekhi ektu/ok
